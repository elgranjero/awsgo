...
import (
	...
	servicecmd "aws/generated/codestarconnections/cmd"
)
...
func main() {
	svc := runtime.ServiceDef{
		...
		OperationInputs: map[string][]string{
			...
			"create-sync-configuration":        {"Branch", "ConfigFile", "PublishDeploymentStatus", "RepositoryLinkId", "ResourceName", "RoleArn", "SyncType", "TriggerResourceUpdateOn"},
			...
			"update-sync-configuration":        {"Branch", "ConfigFile", "PublishDeploymentStatus", "RepositoryLinkId", "ResourceName", "RoleArn", "SyncType", "TriggerResourceUpdateOn"},
		},
		OperationInputTypes: map[string]map[string]string{
			...
			"create-sync-configuration":        {"Branch": "*string", "ConfigFile": "*string", "PublishDeploymentStatus": "types.PublishDeploymentStatus", "RepositoryLinkId": "*string", "ResourceName": "*string", "RoleArn": "*string", "SyncType": "types.SyncConfigurationType", "TriggerResourceUpdateOn": "types.TriggerResourceUpdateOn"},
			...
			"update-sync-configuration":        {"Branch": "*string", "ConfigFile": "*string", "PublishDeploymentStatus": "types.PublishDeploymentStatus", "RepositoryLinkId": "*string", "ResourceName": "*string", "RoleArn": "*string", "SyncType": "types.SyncConfigurationType", "TriggerResourceUpdateOn": "types.TriggerResourceUpdateOn"},
		},
	...
	if err := runtime.ExecuteService("codestarconnections", svc, os.Args[1:]); err != nil {
